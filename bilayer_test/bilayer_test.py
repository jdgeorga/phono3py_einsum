...
phono3py.mesh_numbers = [4, 4, 1]  # You might want to adjust this
...
interaction.fc3_reciprocal = None
start_time = time.time() 
interaction.run(lang = "Fast", num_processes=1)
...
# # Test parallelized Fast method
# print("\n=== Testing Parallelized Fast Method ===")
# interaction.fc3_reciprocal = None
# start_time = time.time()
# # Use the new parallel version - you can control number of processes
# # interaction._run_fast(g_zero=None, num_processes=2)  # Use 2 processes
# # Or let it auto-detect CPU cores:
# interaction._run_fast(g_zero=None)  # Auto-detect number of processes
# fast_parallel_interaction_strength = interaction.interaction_strength
# fast_parallel_fc3_reciprocal = interaction.fc3_reciprocal
# print(f"Parallel Fast interaction took {time.time() - start_time:.4f} seconds")
# print("Parallel fc3_reciprocal shape:", fast_parallel_fc3_reciprocal.shape if fast_parallel_fc3_reciprocal is not None else None)
# print("Parallel fc3_reciprocal access test:", "SUCCESS" if fast_parallel_fc3_reciprocal is not None else "FAILED")
# print("Parallel vs C interaction_strength difference:", np.abs(c_interaction_strength - fast_parallel_interaction_strength).sum())
# print("Parallel vs C fc3_reciprocal difference:", np.abs(c_fc3_reciprocal - fast_parallel_fc3_reciprocal).sum())
